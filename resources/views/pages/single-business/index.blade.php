    ...
    <section class="pt-11 pb-24">
        <div class="tw-container">
            ...
            <div class="mb-7 flex justify-between items-start">
                <div class="">
                    <h1 class="mb-6 text-3xl font-bold text-accent uppercase">{{ $business->name }}</h1>
                    <div class="mb-6 flex items-center">
                        ...
                        <span>{{ $business->metro_stations->pluck('name')->implode(', ') }}</span>
                    </div>

                    <div class="flex text-gray-5 text-sm">
                        <div class="mr-10">{{ $business->created_at->format('d.m.Y') }}</div>
            ...
            <div class="mb-9 flex">
                <div class="max-w-[600px]">
                    ...
                    <div class="swiper mx-0 mb-5 cursor-pointer" data-name="single-business-swiper">
                    ...
                    <div class="swiper" data-name="single-business-swiper-thumbs">
                        <div class="swiper-wrapper">
